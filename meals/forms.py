...
class MakeMacrosForm(forms.models.ModelForm):
        ...
        pct_attrs = {
            'placeholder': '%', 'class': choose_macro_classes,
            'data-value': 0, 'data-type': data_type
        }
        g_attrs = {
            'placeholder': 'g', 'class': choose_macro_classes,
            'data-type': data_type
        }

        height_0 = forms.CharField(label='Height', widget=forms.fields.TextInput(
            attrs={
        ...
        total_macro_percent = forms.IntegerField(
            min_value=100, max_value=100, error_messages=macro_error_messages,
            required=True
        )
