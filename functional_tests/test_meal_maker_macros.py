...
class MakeMacroMealTest(FunctionalTest):
    def test_make_macro_meal(self):
        ...
        self.check_element_content(
            "label[for='goal-meal-cals']", "css", "text", "How many cals in meal?"
        )
        self.check_element_content("goal-meal-cals", "id", "placeholder", "Cals")
        ...
        self.check_element_content("goal-meal-fat-percent", "id", "placeholder", "%")
        self.check_element_content("goal-meal-fat-g", "id", "placeholder", "g")
        self.check_element_content("goal-meal-carbs-percent", "id", "placeholder", "%")
        self.check_element_content("goal-meal-carbs-g", "id", "placeholder", "g")
        self.check_element_content(
            "goal-meal-protein-percent", "id", "placeholder", "%"
        )
        self.check_element_content("goal-meal-protein-g", "id", "placeholder", "g")
